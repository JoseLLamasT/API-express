const content = require('../templates/expressTemplates/expressIndex');
const rouContent = require('../templates/routerTemplate/routerTemplate');
const controllersContent = require('../templates/expressTemplates/expressControllers');
...
function expressCreator(frameworkCongfi, endpoints, db) {
