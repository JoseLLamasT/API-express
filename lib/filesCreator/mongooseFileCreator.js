...
fs.writeFile('./server/models/DBconnection.js',
dbConnectionTemplate.dbSetConection(data.name),function (err) {
  if (err) throw err;
  console.log('File is created successfully.');
});
fs.writeFile('./server/models/schema.js',
schemaTemplate.schemaCreator(data),function (err) {
  if (err) throw err;
  console.log('File is created successfully.');
});
}
